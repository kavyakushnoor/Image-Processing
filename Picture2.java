 ...
 */
public final class Picture2 implements ActionListener {
   ...
   /**
    ...
    public static void main(String[] args) {
        Picture2 pic = new Picture2("lich.png" );
        ...
        for(int i=0;i<imageWidth;i++)
        {
        	for(int j=0;j<imageHeight;j++)
        	{
				...
				Color newColor = new Color(alpha - red,alpha - green, alpha - blue);
        ...
        /* Negative to original color conversion */
